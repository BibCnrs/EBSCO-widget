...
import actions, { BATCH_RETRIEVE, BATCH_RETRIEVE_SUCCESS, EXPORT_NOTICE, EXPORT_NOTICE_SUCCESS, EXPORT_NOTICE_PENDING } from '../actions';
...
export function* exportNotice(action) {
    ...
    yield take(BATCH_RETRIEVE_SUCCESS);
