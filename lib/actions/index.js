...
export const ARTICLE_CHANGE_TERM = 'ARTICLE_CHANGE_TERM';
export const ARTICLE_DOMAIN_CHANGE = 'ARTICLE_DOMAIN_CHANGE';
export const ARTICLE_SEARCH_TERM = 'ARTICLE_SEARCH_TERM';

export const PUBLICATION_CHANGE_TERM = 'PUBLICATION_CHANGE_TERM';
export const PUBLICATION_DOMAIN_CHANGE = 'PUBLICATION_DOMAIN_CHANGE';
export const PUBLICATION_SEARCH_TERM = 'PUBLICATION_SEARCH_TERM';
...
const changeArticleTerm = (term) => ({
    type: ARTICLE_CHANGE_TERM,
    term
});

const changeArticleDomain = (domain) => ({
    type: ARTICLE_DOMAIN_CHANGE,
    domain
});

const searchArticleTerm = () => ({
    type: ARTICLE_SEARCH_TERM
});

const changePublicationTerm = (term) => ({
    type: PUBLICATION_CHANGE_TERM,
    term
});

const changePublicationDomain = (domain) => ({
    type: PUBLICATION_DOMAIN_CHANGE,
    domain
});

const searchPublicationTerm = () => ({
    type: PUBLICATION_SEARCH_TERM
});
...
export default {
    ...
    changeArticleDomain,
    searchArticleTerm,
    changePublicationTerm,
    changePublicationDomain,
    searchPublicationTerm,
    search,
    fetchNotice,
    retrieve,
    showNotice,
