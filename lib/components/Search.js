...
class Search extends Component {
    ...
    render() {
        const { status, error, term, domains, currentDomain, onChangeDomain, onChangeTerm } = this.props;
        return (
    ...
    handleClick() {
        const { term, searchedTerm, currentDomain, onSearchTerm } = this.props;
        if (term !== searchedTerm) {
            onSearchTerm(term, currentDomain);
        }
    }
}
