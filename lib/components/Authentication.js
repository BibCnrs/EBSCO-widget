...
import janus from '../sass/images/janus.png';
import inist from '../sass/images/INIST.png';
            ...
            <Modal className="authentication" show={loginShown} onHide={hideLogin}>
                ...
                <Modal.Body>
                    ...
                    <BibButton
                        ...
                        icon={ status === 'PENDING' ? {name: 'spinner', spin: true } : null }
                        image={status !== 'PENDING' && janus}
