...
import apiLoadHistoryPage from './apiLoadHistoryPage';
import apiDeleteHistory from './apiDeleteHistory';
import apiPersistHistory from './apiPersistHistory';
...
import exactMatchRetrieve from './exactMatchRetrieve';
import retrieveDatabase from './retrieveDatabase';
import piwikTracking from './piwikTracking';
...
export default function* sagas(getState) {
    ...
    yield fork(apiUpdateProfile, getState);
    ...
    yield fork(exactMatchRetrieve, getState);
    yield fork(retrieveDatabase, getState);
    yield fork(apiPersistHistory, getState);
    yield fork(apiLoadHistoryPage, getState);
    yield fork(apiDeleteHistory, getState);
    yield fork(piwikTracking, getState);
}
