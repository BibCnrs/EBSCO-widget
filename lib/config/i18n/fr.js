export default {
    ...
    Profile: {
        ...
        contact: 'Nous contacter',
        favoriteDomain: 'Sélectionnez votre domaine favori dans la liste ci-dessous',
        info: `
...
<p>A tout moment, vous pouvez changer votre domaine favori.</p>`,
    ...
    Error: {
        ...
        RETRIEVE_ERROR_401: 'Vous ne pouvez accéder à cette ressource car vous interrogez un domaine autre que votre domaine autorisé. Veuillez relancer votre requête en sélectionnant votre domaine.',
    ...
    FullTextHolding: {
        date: ({ day, month, year }) => year === '9999' ? 'présent' : `${day}/${month}/${year}`,
    },
    FullTextHoldings: {
