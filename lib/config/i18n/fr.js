export default {
    ...
    DL: {
        ...
        Language: 'Langue',
        PublisherInfo: 'Info Editeur',
        SubjectMESH: 'Sujets MESH',
        Abstract: 'Résumé',
        Comment: 'Commentaire',
        NumberCAS: 'Numéro CAS',
        DateEntry: 'Date d\'Entrée',
        DateUpdate: 'Date de Mises à Jour',
        SubjectOther: 'Autres Sujets',
        ...
        Keyword: 'Mots clef',
        AbstractSuppliedCopyright: 'Droits d\'Auteur Résumé',
        SubjectGeographic: 'Sujet Géographique',
        SubjectCompany: 'Sujets Compagnie',
        PhysDesc: 'Description Physique',
        SubjectThesaurus: 'Sujets Thésaurus',
