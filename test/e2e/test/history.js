...
describe('history', function() {
    ...
    it('should display history', function(done) {
        browser
            ...
            .assert.containsText(
                'tr',
                'Terme recherchés Domaine Limites Facettes Actions',
            )
            .assert.containsText(
                'tr:nth-child(2)',
                'Tout: aids vie Texte intégral; Date de publication: 1914/1918 44 résultats',
            )
            .assert.containsText(
                'tr:nth-child(3)',
                'Tout: phylloxera vie Texte intégral 1189 résultats',
            );
    ...
    it('should translate history', function(done) {
        browser
            ...
            .assert.containsText(
                'tr',
                'Searched terms Discipline Limits Facets Actions',
            )
            .assert.containsText(
                'tr:nth-child(2)',
                'All: aids vie Full text; Publication date: 1914/1918 44 results',
            )
            .assert.containsText(
                'tr:nth-child(3)',
                'All: phylloxera vie Full text 1189 results',
            );
