...
export const getRecordsByIds = (state, category, ids) => {
    return fromSearchResult.getRecordsByIds(state[category], ids);
};
...
export const getTY = (state, category, id) => {
    return fromSearchResult.getTY(state[category], id);
};
