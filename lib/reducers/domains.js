...
export const getDefaultDomain = (state, available = true) => {
    ...
    return domains.includes(state.defaultDomain) ? state.defaultDomain : state.available[0];
};
...
export const getDomainChange = (state) => {
    ...
    return {
        article: state.article !== defaultAvailableDomain ? defaultAvailableDomain : undefined,
