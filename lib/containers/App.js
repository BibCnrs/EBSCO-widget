...
class App extends Component {
    render() {
        const { dispatch, results, search, url, term } = this.props;
        ...
        return (
            <div>
                <Search onClick={text => dispatch(actions.search(url, text))} onChange={term => dispatch(actions.changeTerm(term))} search={search.toJS()} />
