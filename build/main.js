...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsSearch = __webpack_require__(178);

	var _componentsSearch2 = _interopRequireDefault(_componentsSearch);

	var _componentsResultList = __webpack_require__(179);

	var _componentsResultList2 = _interopRequireDefault(_componentsResultList);
	...
	var App = (function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            var _props$results = _props.results;
	            var results = _props$results === undefined ? [] : _props$results;

	            return _react2['default'].createElement(
	                'div',
	                null,
	                _react2['default'].createElement(_componentsSearch2['default'], { onClick: function (text) {
	                        return dispatch(_actions2['default'].search(text));
	                    } }),
	                _react2['default'].createElement(_componentsResultList2['default'], { results: results })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Result = __webpack_require__(180);
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                this.props.results.map(function (result, index) {
	                    return _react2['default'].createElement(_Result2['default'], { text: result, key: index });
	                })
	            );
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	exports.SEARCH_PENDING = SEARCH_PENDING;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middlewareFetch = __webpack_require__(183);

	var _middlewareFetch2 = _interopRequireDefault(_middlewareFetch);
	...
	var createStoreWithMiddleware = (0, _redux.applyMiddleware)(_middlewareFetch2['default'])(_redux.createStore);
	...
	exports['default'] = function (store) {
	    return function (next) {
	        return function (action) {
	            ...
	            (0, _isomorphicFetch2['default'])(request.url, request.config).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function search(state, action) {
	    ...
	    switch (action.type) {
	        case _actions.SEARCH_PENDING:
	            return 'PENDING';
	        case _actions.SEARCH_SUCCESS:
	            return 'SUCCESS';
	        case _actions.SEARCH_ERROR:
	            return 'ERROR';
	        default:
	            return state;
	    }
