...
export const DatabaseLetter = ({ databases, language, domain, clickDb }) => {
    return (
        <ul>
                ...
                return (
                    <li key={name.replace(' ', '_')}>
                        <DatabaseItem
                            ...
                            url={`https://${domain.toLowerCase()}.bib.cnrs.fr/login?url=${
...
export const Database = ({ databases, language, domain, clickDb }) => {
