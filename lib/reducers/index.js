...
export const getSelectedRecordsRisLink = createSelector(
    [getCurrentSearchResult, getSelectedRecordIds],
...
export const getSelectedRecordsRisRequest = createSelector(
    [getSelectedRecordsRisLink, getUrl],
    (links, url) => ({
