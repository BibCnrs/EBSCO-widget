...
export const History = ({ queries, historyShown, text, reloadHistory, restoreHistory, deleteHistory, canPersistHistoryOnServer, currentPage, maxPage, loadPage }) => {
    const fieldLabel = {
        [null]: text.all,
        AU: text.author,
        AR: text.exactAuthor,
                        ...
                        <Table striped bordered condensed hover>
                            {canPersistHistoryOnServer &&
                                <thead>
                                    <tr>
                                        <td colSpan={5}>
                                            <Pagination currentPage={currentPage} maxPage={maxPage} loadPage={loadPage} />
                                        </td>
                                    </tr>
                                </thead>
                            }
