...
const initialize = (url, dbUrl, domain, language) => ({
    type: INITIALIZE,
    url,
    dbUrl,
    domain,
...
const exactMatchSearchSuccess = (response) => ({
    type: EXACT_MATCH_SEARCH_SUCCESS,
    response
});

const exactMatchSearchError = (error) => ({
    type: EXACT_MATCH_SEARCH_ERROR,
    error
});
...
export default {
    ...
    fetchError,
    fetchCancel,
    exactMatchSearchSuccess,
    exactMatchSearchError
};
