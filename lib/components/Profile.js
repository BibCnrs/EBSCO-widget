...
import GoogleScholarParameter from './GoogleScholarParameter';
...
const Profile = ({
    ...
    <Modal show={profileShown} onHide={hideProfile}>
        ...
        <Modal.Body className="profile">
            <Tabs defaultEventKey={1}>
                ...
                <Tab title={text.googleScholarTab} eventKey={3}>
                    <GoogleScholarParameter />
                </Tab>
