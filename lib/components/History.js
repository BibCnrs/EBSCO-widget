...
export class History extends Component {
    ...
    handleLoadHistoryPage = (page, limit) => {
        ...
        loadHistoryPage(page, limit, showOnlyAlert);
        if (limit) {
    ...
    handleShowOnlyAlertChange = () => {
        const { currentPage, loadHistoryPage } = this.props;
        const showOnlyAlert = !this.state.showOnlyAlert;
        this.setState({ showOnlyAlert });
        loadHistoryPage(currentPage, this.state.resultsPerPage, showOnlyAlert);
    };
...
<ResultsPerPageSelector
    resultsPerPage={5}
    changeResultsPerPage={limit => this.handleLoadHistoryPage(1, limit)}
