...
export const getDomainsRequest = createSelector([getUrl], url => console.log(url) || ({
    url: `${url}/domains`,
    config: {
        headers: {
            Accept: 'application/json',
...
export const getApiLogoutRequest = createSelector([getUrl], url => {
    return {
        url: `${url}/logout`,
        config: {
            method: 'POST',
