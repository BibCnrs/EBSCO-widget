export default {
    ...
    Error: {
        API_LOGIN_ERROR: `Identifiant invalide`,
        ARTICLE_RETRIEVE_ERROR: `La notice de l'article n'a put être récupéré`,
        ARTICLE_RETRIEVE_LINK_ERROR: `Les liens vers le texte intégrale n'ont pu être récupéré`,
        ARTICLE_SEARCH_ERROR: `La recherche à échoué`,
        PUBLICATION_SEARCH_ERROR: `La recherche à échoué`,
        PUBLICATION_RETRIEVE_ERROR: `La notice de du titre n'a put être récupéré`,
        A2Z_SEARCH_ERROR: `La recherche à échoué`,
        A2Z_RETRIEVE_ERROR: `La notice de du titre n'a put être récupéré`,
        FETCH_DOMAINS_ERROR: `La liste des domaines n'a pu être récupéré`,
        ACCESS_ERROR: `Vous n'avez pas accés aux notices de ce domaine`,
        400: '400 - Bad Request',
    ...
    NoAccessToDomain: {
        ...
        message: 'Vous n\'avez pas accés au domaine'
    },
    PrettyLimiter: {
