...
export const getRecordsByIds = (state, ids) => {
    return fromSearchResultSelectors.getRecordsByIds(state.searchResult, getLocation(state), ids);
};
...
export const makeIsRecordSelected = () => createSelector(
    [ getSelectedRecord, getLocation, (_, id) => id ],
    fromSelectedRecord.isRecordSelected
);
export const getSelectedRecordIds = createSelector(getSelectedRecord, getLocation, fromSelectedRecord.getSelectedRecordIds);
