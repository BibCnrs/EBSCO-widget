...
describe('Facet', function () {
    ...
    it('should display a FacetValue foreach availableFacetValues', function () {
        ...
        assert.deepEqual(facetValues.map(facetValue => facetValue.props().facetValue), defaultFacet.availableFacetValues);
    });
    ...
    it('should display only the first three availableFacetValues as FacetValue when state.showAll is default false', function () {
        ...
        assert.deepEqual(facetValues.map(facetValue => facetValue.props().facetValue), availableFacetValues.slice(0, 3));
    });
    ...
    it('should display all availableFacetValues as FacetValue when state.showAll is true', function () {
        ...
        assert.deepEqual(facetValues.map(facetValue => facetValue.props().facetValue), availableFacetValues);
    });
