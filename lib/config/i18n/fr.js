...
Si le problème persiste, n'hésitez pas à contacter assistance-portail@inist.fr`,
    ...
    GoogleScholarParameter: {
        explanation: `Pour faciliter l’accès au texte intégral des articles présents dans Google Scholar et accessibles via BibCnrs, il suffit de paramétrer votre moteur de recherche. Vous repérerez dans la liste des résultats de Google Scholar de façon instantanée les articles disponibles en texte intégral dans votre domaine.`,
        chooseDomain: link =>
            `Cliquez sur le <a href="${link}" target="_blank">lien</a> et sélectionnez votre ou vos domaine(s) autorisé(s)`,
        saveSettings:
            'Pour conserver ces paramètres, vous devez activer les cookies. Cliquez enfin sur le bouton "Enregistrer".',
    },
