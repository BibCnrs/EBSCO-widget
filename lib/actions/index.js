...
export const CHANGE_FULLTEXT = 'CHANGE_FULLTEXT';
export const CHANGE_PEER_REVIEWED = 'CHANGE_PEER_REVIEWED';
...
const limitFullText = (fullText) => ({
    type: CHANGE_FULLTEXT,
    fullText
});

const limitPeerReviewed = (peerReviewed) => ({
    type: CHANGE_PEER_REVIEWED,
    peerReviewed
});
