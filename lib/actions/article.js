...
export const CHANGE_QUERY_TERM = 'ARTICLE_CHANGE_QUERY_TERM';
export const CHANGE_QUERY_FIELD = 'ARTICLE_CHANGE_QUERY_FIELD';
export const CHANGE_QUERY_BOOLEAN = 'ARTICLE_CHANGE_QUERY_BOOLEAN';
...
const changeQueryTerm = (value, index = 0) => ({
    type: CHANGE_QUERY_TERM,
    index,
    value
});

const changeQueryField = (value, index = 0) => ({
    type: CHANGE_QUERY_FIELD,
    index,
    value
});

const changeQueryBoolean = (value, index = 0) => ({
    type: CHANGE_QUERY_BOOLEAN,
    index,
    value
});
