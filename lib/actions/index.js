...
export const CHANGE_ALL_TERM = 'CHANGE_ALL_TERM';
export const CHANGE_ALL_SEARCH_DOMAIN = 'CHANGE_ALL_SEARCH_DOMAIN';
...
export const API_DELETE_HISTORY = 'API_DELETE_HISTORY';
export const API_DELETE_HISTORY_PENDING = 'API_DELETE_HISTORY_PENDING';
export const API_DELETE_HISTORY_ERROR = 'API_DELETE_HISTORY_ERROR';
export const API_DELETE_HISTORY_CANCEL = 'API_DELETE_HISTORY_CANCEL';
export const API_DELETE_HISTORY_SUCCESS = 'API_DELETE_HISTORY_SUCCESS';

export const API_DELETE_HISTORIES = 'API_DELETE_HISTORIES';
export const API_DELETE_HISTORIES_PENDING = 'API_DELETE_HISTORIES_PENDING';
export const API_DELETE_HISTORIES_ERROR = 'API_DELETE_HISTORIES_ERROR';
export const API_DELETE_HISTORIES_CANCEL = 'API_DELETE_HISTORIES_CANCEL';
export const API_DELETE_HISTORIES_SUCCESS = 'API_DELETE_HISTORIES_SUCCESS';

export const ADD_FAVOURITE_RESOURCE = 'ADD_FAVOURITE_RESOURCE';
export const REMOVE_FAVOURITE_RESOURCE = 'REMOVE_FAVOURITE_RESOURCE';
export const MOVE_FAVOURITE_RESOURCE = 'MOVE_FAVOURITE_RESOURCE';

export const CLICK_DB = 'CLICK_DB';

export const START_ANIMATE_PROFILE = 'START_ANIMATE_PROFILE';
export const STOP_ANIMATE_PROFILE = 'STOP_ANIMATE_PROFILE';
...
export const DISABLE_ALL_ALERT = 'DISABLE_ALL_ALERT';
...
const persistHistorySuccess = response => ({
    type: API_PERSIST_HISTORY_SUCCESS,
    response,
});

const loadHistoryPage = (page, limit, has_alert) => ({
...
const loadHistoryPageSuccess = (history, page) => ({
...
const deleteHistoryFromServer = id => ({
    type: API_DELETE_HISTORY,
    id,
});

const deleteHistoryFromServerPending = () => ({
    type: API_DELETE_HISTORY_PENDING,
});

const deleteHistoryFromServerError = response => ({
    type: API_DELETE_HISTORY_ERROR,
    response,
});

const deleteHistoryFromServerCancel = error => ({
    type: API_DELETE_HISTORY_CANCEL,
    error,
});

const deleteHistoryFromServerSuccess = () => ({
    type: API_DELETE_HISTORY_SUCCESS,
});

const deleteHistoriesFromServer = () => ({
    type: API_DELETE_HISTORIES,
});

const deleteHistoriesFromServerPending = () => ({
    type: API_DELETE_HISTORIES_PENDING,
});

const deleteHistoriesFromServerError = response => ({
    type: API_DELETE_HISTORIES_ERROR,
    response,
});

const deleteHistoriesFromServerCancel = error => ({
    type: API_DELETE_HISTORIES_CANCEL,
    error,
});

const deleteHistoriesFromServerSuccess = () => ({
    type: API_DELETE_HISTORIES_SUCCESS,
});
...
const changeAllSearchDomain = domain => ({
...
const changeAllTerm = (term, index = 0) => ({
...
const changeField = (category, value, index = 0) =>
    changeQuery(category, value, 'field', index);
...
const changeLetters = (firstLetter, secondLetter) =>
    changeQuery('publication', getTerm(firstLetter, secondLetter), 'term', 0);
...
const clickDb = (domain, name) => ({
    type: CLICK_DB,
    domain,
    name,
});

const addFavouriteResource = resource => ({
    type: ADD_FAVOURITE_RESOURCE,
    resource,
});

const removeFavouriteResource = url => ({
    type: REMOVE_FAVOURITE_RESOURCE,
    url,
});

const moveFavouriteResource = ({ oldIndex, newIndex }) => ({
    type: MOVE_FAVOURITE_RESOURCE,
    oldIndex,
    newIndex,
});

const startAnimateProfile = () => ({ type: START_ANIMATE_PROFILE });
const stopAnimateProfile = () => ({ type: STOP_ANIMATE_PROFILE });

const saveAlert = (historyId, frequence) => ({
    type: SAVE_ALERT,
    historyId,
    frequence,
});
const saveAlertError = (historyId, frequence) => ({
    type: SAVE_ALERT_ERROR,
    historyId,
    frequence,
});

const removeAlert = historyId => ({
    type: REMOVE_ALERT,
    historyId,
});

const disableAlert = historyId => ({
    type: DISABLE_ALERT,
    historyId,
});

const disableAllAlert = limit => ({
    type: DISABLE_ALL_ALERT,
    limit,
});
...
export default {
    ...
    deleteHistoryFromServerPending,
    deleteHistoryFromServerError,
    deleteHistoryFromServerCancel,
    deleteHistoryFromServerSuccess,
    deleteHistoriesFromServer,
    deleteHistoriesFromServerPending,
    deleteHistoriesFromServerError,
    deleteHistoriesFromServerCancel,
    deleteHistoriesFromServerSuccess,
    clickDb,
    addFavouriteResource,
    removeFavouriteResource,
    moveFavouriteResource,
    startAnimateProfile,
    stopAnimateProfile,
    saveAlert,
    saveAlertError,
